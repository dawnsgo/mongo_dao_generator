...
func usage() {
	fmt.Fprintf(os.Stderr, "Usage of mongo_dao_generator:\n")
	fmt.Fprintf(os.Stderr, "\tmongo_dao_generator [flags] -model-dir=. -model-names=T,T -dao-dir=./dao\n")
	fmt.Fprintf(os.Stderr, "For more information, see:\n")
	fmt.Fprintf(os.Stderr, "\thttps://github.com/dawnsgo/mongo_dao_generator\n")
	fmt.Fprintf(os.Stderr, "Flags:\n")
	flag.PrintDefaults()
}

//go:generate mongo_dao_generator -type=Mail,User
func main() {
	log.SetFlags(0)
	log.SetPrefix("mongo_dao_generator: ")
	flag.Usage = usage
	flag.Parse()
