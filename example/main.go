...
import (
	...
	"github.com/dawnsgo/mongo_dao_generator/example/dao"
	"github.com/dawnsgo/mongo_dao_generator/example/model"
...
func main() {
	...
	_, err = mailDao.InsertOne(baseCtx, &model.Mail{
		Title:    "mongo_dao_generator introduction",
		Content:  "the mongo_dao_generator is a tool for automatically generating MongoDB Data Access Object.",
		Sender:   1,
		Receiver: 2,
		Status:   1,
	})
